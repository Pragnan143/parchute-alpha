      ...
      <div className='w-[80%] justify-center items-center gap-8 flex'>
        <div className='flex-col w-[40%] h-[80%] p-4 border-purple-500 border-2 gap-5 rounded-[10px]'>
          <div className='flex flex-col gap-5'>
            ...
            <div>
              <p className='text-justify'>I'm a daya secience entushist have done projects on Ai- enabled personlised education system, chess-fide ranking, sives of erathones I'm a daya secience entushist have done projects on Ai- enabled personlised education system, chess-fide ranking, sives of erathones I'm a daya secience entushist have done projects on Ai- enabled personlised education system, chess-fide ranking, sives of erathones</p>
            </div>
          </div>
        </div>
      </div>
