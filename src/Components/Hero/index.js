            ...
            <div class="flex w-[100%] pt-12">
                <div class="flex flex-col justify-center gap-10 w-[60%]">
                    ...
                    <div class="flex flex-row justify-center gap-[50px]">
                        ...
                        <div class="border-2 p-2 text-white border-purple-600 hover:bg-purple-200 rounded-md text-[20px] h-auto w-auto bg-purple-600 hover:text-black  cursor-pointer">
                            <p>Explore</p>{" "}
                        </div>
                    </div>
                </div>
